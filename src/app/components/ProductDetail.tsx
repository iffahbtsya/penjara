...
const PRODUCTS: Record<number, {
  ...
  2: { id: 2, name: "Mahogany Bookshelf", cat: "kayu", price: 890, rating: 4.9, reviews: 27, image: "https://images.unsplash.com/photo-1618220179428-22790b461013?w=700&h=500&fit=crop&auto=format", gallery: ["https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=200&h=150&fit=crop&auto=format", "https://images.unsplash.com/photo-1555041469-a586c61ea9bc?w=200&h=150&fit=crop&auto=format"], description: "Solid mahogany bookshelf with 5 adjustable shelves. Classic joinery with a smooth lacquer finish that protects the rich reddish-brown grain.", material: "Solid Mahogany, Lacquer Finish", dimensions: "90cm × 30cm × 190cm", stock: 5 },
  3: { id: 3, name: "Oak Side Table", cat: "kayu", price: 340, rating: 4.6, reviews: 18, image: "https://images.unsplash.com/photo-1555041469-a586c61ea9bc?w=700&h=500&fit=crop&auto=format", gallery: [], description: "Minimalist oak side table with tapered legs. Perfect beside a sofa or bed.", material: "Solid Oak, Matte Wax Finish", dimensions: "45cm × 45cm × 55cm", stock: 12 },
  4: { id: 4, name: "Wooden Jewellery Box", cat: "kayu", price: 95, rating: 4.7, reviews: 44, image: "https://images.unsplash.com/photo-1606722590583-6951b5ea92ad?w=700&h=500&fit=crop&auto=format", gallery: [], description: "Intricately carved jewellery box with velvet-lined interior and brass hinge. Makes a perfect gift.", material: "Teak & Rosewood Veneer, Velvet Interior", stock: 20 },
  5: { id: 5, name: "Rattan Wall Decor", cat: "kayu", price: 180, rating: 4.5, reviews: 29, image: "https://images.unsplash.com/photo-1585412727339-54e4bae3bbf9?w=700&h=500&fit=crop&auto=format", gallery: [], description: "Hand-woven rattan wall art panel with geometric pattern. Adds warmth and texture to any room.", material: "Natural Rattan, Hand-woven", dimensions: "60cm × 60cm", stock: 15 },
  6: { id: 6, name: "Steel Clothes Drying Rack", cat: "besi", price: 185, rating: 4.6, reviews: 52, image: "https://images.unsplash.com/photo-1556228578-8c89e6adf883?w=700&h=500&fit=crop&auto=format", gallery: [], description: "Heavy-duty powder-coated steel drying rack with 3 telescoping bars. Folds flat for easy storage. Weight capacity: 15kg.", material: "Powder-Coated Carbon Steel", dimensions: "120cm × 55cm × 90cm (extended)", stock: 30 },
  7: { id: 7, name: "Industrial Shelf Unit", cat: "besi", price: 420, rating: 4.8, reviews: 21, image: "https://images.unsplash.com/photo-1558618666-fcd25c85cd64?w=700&h=500&fit=crop&auto=format", gallery: [], description: "5-tier industrial steel shelf unit with adjustable brackets. Perfect for warehouses, garages, or modern interiors. Load capacity 50kg per shelf.", material: "Cold-Rolled Steel, Epoxy Powder Coat", dimensions: "90cm × 40cm × 180cm", stock: 10 },
  8: { id: 8, name: "Metal Locker Cabinet", cat: "besi", price: 650, rating: 4.5, reviews: 16, image: "https://images.unsplash.com/photo-1586023492125-27b2c045efd7?w=700&h=500&fit=crop&auto=format", gallery: [], description: "4-door steel locker cabinet with individual keys. Built for schools, gyms, and offices. Ventilated panels prevent moisture build-up.", material: "CRCA Steel, Electrostatically Coated", dimensions: "30cm × 45cm × 180cm per door", stock: 7 },
  9: { id: 9, name: "Iron Coat Rack", cat: "besi", price: 120, rating: 4.7, reviews: 38, image: "https://images.unsplash.com/photo-1567538096630-e0c55bd6374c?w=700&h=500&fit=crop&auto=format", gallery: [], description: "Wrought iron freestanding coat rack with 8 hooks and umbrella base. Classic industrial design that complements any interior.", material: "Wrought Iron, Matte Black Finish", dimensions: "40cm base × 170cm tall", stock: 22 },
  10: { id: 10, name: "Steel Workbench", cat: "besi", price: 780, rating: 4.9, reviews: 12, image: "https://images.unsplash.com/photo-1504917595217-d4dc5ebe6122?w=700&h=500&fit=crop&auto=format", gallery: [], description: "Heavy-gauge steel workbench with pegboard back panel and lower shelf. Ideal for workshops and garages. Supports up to 200kg.", material: "Heavy-Gauge Steel, Galvanized Top", dimensions: "150cm × 60cm × 90cm", stock: 6 },
  11: { id: 11, name: "Classic Cotton Polo", cat: "baju", price: 65, rating: 4.7, reviews: 91, image: "https://images.unsplash.com/photo-1581655353564-df123a1eb820?w=700&h=500&fit=crop&auto=format", gallery: [], description: "100% combed cotton polo shirt with 3-button placket. Pre-shrunk and colour-fast for long-lasting wear.", material: "100% Combed Cotton, 220gsm", sizes: ["XS", "S", "M", "L", "XL", "XXL"], colors: ["White", "Navy", "Black", "Charcoal"], stock: 50 },
  12: { id: 12, name: "Heavy Duty Work Shirt", cat: "baju", price: 89, rating: 4.8, reviews: 63, image: "https://images.unsplash.com/photo-1598033129183-c4f50c736f10?w=700&h=500&fit=crop&auto=format", gallery: [], description: "Durable long-sleeve work shirt with reinforced elbows and chest pockets. Designed for tradespeople and craftsmen.", material: "65% Polyester / 35% Cotton Blend, 240gsm", sizes: ["S", "M", "L", "XL", "XXL", "3XL"], colors: ["Khaki", "Navy", "Olive", "Black"], stock: 40 },
  13: { id: 13, name: "Linen Casual Shirt", cat: "baju", price: 78, rating: 4.5, reviews: 47, image: "https://images.unsplash.com/photo-1523381210434-271e8be1f52b?w=700&h=500&fit=crop&auto=format", gallery: [], description: "Breathable linen shirt with a relaxed, oversized silhouette. Perfect for casual or smart-casual occasions.", material: "100% Linen", sizes: ["S", "M", "L", "XL", "XXL"], colors: ["Off-White", "Sand", "Sage", "Sky Blue"], stock: 35 },
